...
public class CaptureActivity extends Activity {
	...
	private Button mBtnCapturePicture = null, mBtnReg = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnReg = (Button) findViewById(R.id.bttnRegister);
		mBtnReg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dataBundle.putString("photo", mCurrentPhotoPath);

				Intent registerIntent = new Intent(getApplicationContext(),
						RegisterActivity.class);
				
				registerIntent.putExtras(dataBundle);
