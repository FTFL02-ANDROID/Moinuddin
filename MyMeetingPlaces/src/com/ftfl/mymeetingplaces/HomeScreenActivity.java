	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnReg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent registerIntent = new Intent(getApplicationContext(),MeetingPlaceActivity.class);
		...
		mBtnRevw.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent reviewIntent = new Intent(getApplicationContext(),MyVisitedPlaceActivity.class);
